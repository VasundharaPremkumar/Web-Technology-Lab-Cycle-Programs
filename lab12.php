...
form { 
background: #fff; margin: 0 8rem; border: 1px solid; 
} 
label { 
display: block; font-weight: bold; font-size: 1.2rem; margin-top: 20px; 
} 
input { 
display: block; margin: 0 auto; padding: 5px; 
} 
button { 
margin: 10px auto; display: block; padding: 1rem; 
} 
</style> 
</head> 
<body> 
